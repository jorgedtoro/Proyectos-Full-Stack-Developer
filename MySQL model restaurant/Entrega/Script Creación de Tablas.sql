...
('Kebaps Pepe', 'Calle del kebap, 32,23417,Alicante','+34696548778','Berto Negro',0),
...
CREATE TABLE IF NOT EXISTS `restaurantes`.`mesas` (
  ...
  INDEX `fk_mesas_clientes1_idx` (`clientes_id` ASC),
...
CREATE TABLE IF NOT EXISTS `restaurantes`.`favoritos` (
  ...
  `locales_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_clientes_has_locales_locales1_idx` (`locales_id` ASC),
  INDEX `fk_clientes_has_locales_clientes1_idx` (`clientes_id` ASC),
